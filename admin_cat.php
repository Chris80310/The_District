...
<div class="container col-md-7 div_cat mt-5 py-5 bg_admin">
    ...
    <div class="text-center mb-5">
        <a href="form_ajout_cat.php" class="col-md-2 col-4 btn btn-light btn-sm mx-3">Ajouter une catégorie</a>
    ...
    <div class="table-responsive">
        <table class="table_c table-bordered mx-3 table_admin">
            <thead>
                <tr>
                    <th class="col-md-2 text-center">Nom de la catégorie</th>
                ...
                <?php foreach ($categories as $category) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="form_modif_cat.php?id=<?= $category->id ?>" class="col-md-5 col-12 btn btn-light btn-sm">Modifier</a>
                        
                            <form method="POST">
                                <a href="admin_cat.php?id=<?=$category->id ?>" class="del col-md-5 col-12 my-2 btn btn-sm btn-light "
