...
<div class="container col-7 div_cat mt-5 py-5 bg_admin">
    <div>
        ...
        <div class="text-center mb-5">
            <a href="" class="btn btn-light btn-sm">Ajouter une catégorie</a>
        </div>
                ...
                <?php foreach ($categories as $category) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="modif_cat.php=<?= $category->id ?>" class="btn btn-light btn-sm ">Modifier</a>
                            <a href="suppr_cat.php=<?= $category->id ?>" class="btn btn-light btn-sm ">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
