            ...
            <div class="">
                <div class="row my-5 m-auto">
                    ...
                    <div class="col-md-9 col-12">
                        <input type="text" class="col-md-8 col-12 form" name="nom" id="form">
                    </div>
                </div>
                ...
                <div class="row my-5 m-auto">
                    ...
                    <div class="col-md-9 col-12">
                        <input type="text" class="col-md-8 col-12 form" name="prenom" id="form">
                    </div>
                </div>
                ...
                <div class="row my-5 m-auto">
                    ...
                    <div class="col-md-9 col-12">
                        <input type="text" class="col-md-8 col-12 form" name="email" id="form" placeholder=" Exemple@service.com">
                    </div>
                </div>   
                ...
                <div class="row my-5 m-auto">
                    ...
                    <div class="col-md-9 col-12">
                        <input type="number" class="col-md-8 col-12 form" name="tel" id="form">
                    </div>
                </div> 
                ...
                <div class="row my-5 m-auto">
                    ...
                    <div class="col-md-9 col-12">
                        <textarea cols="20" rows="10" class="col-md-8 col-12 form" name="mess" id="form" placeholder=" Votre message ici"></textarea>
                    </div>
                </div> 
