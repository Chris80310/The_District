...
CREATE DATABASE IF NOT EXISTS `chris80` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `chris80`;
...
-- Listage des données de la table the_district.commande : ~15 rows (environ)
