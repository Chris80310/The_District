...
$nom_cat   = (isset($_POST['Nom_cat']) && $_POST['Nom_cat'] != "") ? $_POST['Nom_cat'] : Null;
...
if ($Nom_cat == Null || $active == Null || $genre == Null || $label == Null || $price == Null || $name == Null) {
...
try {
    ...
    $requete = $db->prepare("INSERT INTO disc (disc_title, disc_Active, disc_genre, disc_label, disc_price, artist_id, disc_picture) VALUES (:Nom_cat, :active, :genre, :label, :price, :name, :picture);");
    
    // Association des valeurs aux paramètres via bindValue() :
    $requete->bindValue(":Nom_cat", $Nom_cat,   PDO::PARAM_STR);
